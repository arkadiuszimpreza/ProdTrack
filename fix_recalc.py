...
recalc_fn = """  const handleRecalculate = async () => {
...
# Remove the previously injected function
content = content.replace(recalc_fn, '')

# Now insert it before the main return statement of OrderLogsView
# We can find `  return (\n    // Zamiast małego modala`
content = content.replace('  return (\n    // Zamiast małego modala', recalc_fn + '\n  return (\n    // Zamiast małego modala')
